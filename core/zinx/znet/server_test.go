...
//Test PreHandle
func (this *PingRouter) PreHandle(request ziface.IRequest) error {
...
//Test Handle
func (this *PingRouter) Handle(request ziface.IRequest) error {
...
//Test PostHandle
func (this *PingRouter) PostHandle(request ziface.IRequest) error {
...
func (this *HelloRouter) Handle(request ziface.IRequest) error {
